...
public class SpoofaxTestParseController extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SpoofaxTest");
  ...
  { 
    try
    { 
      InputStream descriptorStream = SpoofaxTestParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SpoofaxTestParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SpoofaxTestParseController.class);
    }
  ...
  { 
    return SpoofaxTestParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
